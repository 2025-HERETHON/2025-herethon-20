# TOOK
2025 여기톤 : HER+ETHON 20팀 - 여성들의 고민을 있는 그대로, "툭"
...
- **Q&A 게시판**:
  -전문의- 게시판:카테고리에 해당하는 글 찾기
  작성: 카테고리에 맞는 글 작성 및 수정
  게시글: 구제적인 글 확인 및 댓글
  검색: 제목 및 내용 키워드로 글 찾기
  내 답변/게시물 : 자신이 작성한 글/ 게시물 한 눈에 확인
  
  -사용자:  게시판:카테고리에 해당하는 글 찾기
  게시글: 구제적인 글 확인 및 댓글
  검색: 제목 및 내용 키워드로 글 찾기
...
- **마이페이지**:
  일반 회원의 경우 - 스크랩한 게시물, 알림 설정
  전문의 회원의 경우 - 본인이 답변한 게시물, 스크랩 게시물, 알림 설정
...
* **박소연**: 멋쟁이사자처럼 13기 아기사자 | **프론트엔드** (안심병원 추천, 홈화면, 간편병원예약, 마이페이지) | 숙명여자대학교 컴퓨터과학전공
* **이민아**: 멋쟁이사자처럼 13기 아기사자 | **프론트엔드** (Q&A 게시판) | 덕성여자대학교 가상현실융합학과
